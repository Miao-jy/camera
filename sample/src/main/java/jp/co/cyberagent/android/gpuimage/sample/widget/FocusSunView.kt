...
class FocusSunView : View {
            ...
            if (!reset) {
                ...
                if (focusAnimator != null) {
                    focusAnimator?.addUpdateListener { animation ->
                        ...
                        frameRectF.left =
                            left - (((right - left) / 5f) - (((right - left) / 5f) * value))
                        frameRectF.right =
                            right + ((right - left) / 5f - (((right - left) / 5f) * value))
                        frameRectF.top =
                            top - ((bottom - top) / 5f - (((bottom - top) / 5f) * value))
                        frameRectF.bottom =
                            bottom + ((bottom - top) / 5f - (((bottom - top) / 5f) * value))
                        postInvalidate()
                    }
    ...
    override fun onDraw(canvas: Canvas?) {
        ...
        canvas?.apply {
            ...
            if (showLine) {
                if (circleY != circleRadius + dp8) {
                    drawLine(
                        ...
                        0f,
                        centerOfCircle,
                        (height * progress) - (circleRadius) - dp10,
                        sunPaint
                    )
                }
            ...
            if (realProcess < .5f) {
                ...
                drawArc(
                    centerOfCircle - (circleRadius - dp2),
                    (height * progress) - (circleRadius - dp2),
                    centerOfCircle + (circleRadius - dp2),
                    (height * progress) + (circleRadius - dp2),
                    90f,
                    180f,
                ...
                val bottom = (height * progress) + (circleRadius - dp2)
                drawArc(
                    centerOfCircle - (circleRadius - dp2 - 1),
                    (height * progress) - (circleRadius - dp2 - 1),
                    centerOfCircle + (circleRadius - dp2 - 1),
                    (height * progress) + (circleRadius - dp2 - 1),
                    90f,
                    180f,
            ...
            when (ev.action) {
                ...
                MotionEvent.ACTION_MOVE -> {
                    ...
                    if ((curPosY - posY > 0) || (curPosY - posY < 0)) {
                        ...
                        realProcess =
                            (((circleY - (circleRadius + dp8)) / ((height - circleRadius - dp8) - (circleRadius + dp8))) * 100f).roundToInt() / 100.0f
                        progress = circleY / height
                        angle = 360f * realProcess
                        val absolutelyProcess =
                            (((((height - circleRadius - dp8) - (circleRadius + dp8)) - (circleY - (circleRadius + dp8))) / ((height - circleRadius - dp8) - (circleRadius + dp8))) * 100f).roundToInt() / 100.0f
                        val step = upperExposureLimit - lowerExposureLimit
                        val exposure =
                            (((step * absolutelyProcess) + lowerExposureLimit) * 100f).roundToInt() / 100.0f
    ...
    private fun dp2px(context: Context, dp: Float): Float =
        dp * context.resources.displayMetrics.density + .5f
}